...
export function DomainWizard() {
  ...
  const onSearchSubmit = async (values: z.infer<typeof SearchSchema>) => {
    ...
    try {
      const response = await fetch("http://webconcoction.com/api/namecheap/check", {
        method: "POST",
  ...
  const onRegisterSubmit = async (values: z.infer<typeof RegistrationSchema>) => {
    ...
    try {
      const response = await fetch("http://webconcoction.com/api/namecheap/register", {
        method: "POST",
        headers: { "Content-Type": "application/json" },
        body: JSON.stringify({
  ...
  const onCreateHostingSubmit = async (values: z.infer<typeof HostingSchema>) => {
    ...
    try {
      const response = await fetch("http://webconcoction.com/api/whm/create", {
        method: "POST",
        headers: { "Content-Type": "application/json" },
        body: JSON.stringify({
          domain: selectedDomain.domain,
